    ...
    return (
      <div className="page page-dashboard">
        ...
        <nav className="bottom-tabs" aria-label="Primary">
          <button className="tab-btn" type="button" aria-label="Rank">
            <svg viewBox="0 0 24 24" aria-hidden="true" className="tab-icon">
              <path d="M4 16.5a1 1 0 0 0 1.7.7l4-3.7 3 2.5a1 1 0 0 0 1.2 0l4.8-3.5a1 1 0 1 0-1.2-1.6l-4.2 3.1-3-2.5a1 1 0 0 0-1.3.04L5 14.3V9a1 1 0 1 0-2 0v7.5Z" />
            </svg>
          </button>
          ...
          <button className="tab-btn active" type="button" aria-label="Home">
            <svg viewBox="0 0 24 24" aria-hidden="true" className="tab-icon">
